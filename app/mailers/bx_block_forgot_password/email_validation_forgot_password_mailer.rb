module BxBlockForgotPassword
  class EmailValidationForgotPasswordMailer < ApplicationMailer
    def activation_email
      ...
      @reset_password_url = BxBlockAdminEmailNotification::AdminEmailNotification.find_by(notification_name:  "Verify Your Account/ Forgot Password/ Change Password")&.content

      if @reset_password_url.present?
        doc = Nokogiri::HTML::DocumentFragment.parse(@reset_password_url)
      ...
      mail(
          ...
          subject: 'Password Reset Email') do |format|
